...
public class DynamiteEntity extends ThrownItemEntity {
    ...
    public DynamiteEntity(World world, LivingEntity owner) {
        super((EntityType<? extends ThrownItemEntity>)ModEntities.DYNAMITE, owner, world);
    }

    public DynamiteEntity(World world, double x, double y, double z) {
        super((EntityType<? extends ThrownItemEntity>) ModEntities.DYNAMITE, x, y, z, world);
    }
    ...
    protected void onEntityHit(EntityHitResult entityHitResult) {
        ...
        this.discard();
        float f = 4.0f;
        this.getWorld().createExplosion(this, this.getX(), this.getBodyY(0.0625), this.getZ(), 3.0f, World.ExplosionSourceType.TNT);
    }
