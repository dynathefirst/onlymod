...
import net.dyna.onlymod.screen.FreezerScreenHandler;
...
public class FreezerBlockEntity extends BlockEntity implements ExtendedScreenHandlerFactory, ImplementedInventory {
    ...
    protected void writeNbt(NbtCompound nbt) {
        ...
        nbt.putInt("freezer.onlymod.progress", progress);
    }
    ...
    public void readNbt(NbtCompound nbt) {
        ...
        progress = nbt.getInt("freezer.onlymod.progress");
    }
    ...
    public Text getDisplayName() {
        return Text.translatable("freezer.onlymod.name");
    }
    ...
    private boolean hasRecipe() {
        ItemStack result = new ItemStack(Items.ICE);
        boolean hasInput = getStack(INPUT_SLOT).getItem() == Items.WATER_BUCKET;
